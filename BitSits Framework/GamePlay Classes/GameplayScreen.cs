...
namespace BitSits_Framework
{
    ...
    class GameplayScreen : GameScreen
    {
        ...
        const float MaxTimeToLoadNextLevel = 1.5f;
        float timeToLoadNextLevel;
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (IsActive)
            {
                ...
                if (level.IsLevelUp) timeToLoadNextLevel += (float)gameTime.ElapsedGameTime.TotalSeconds;
                if (level.IsLevelUp && timeToLoadNextLevel > MaxTimeToLoadNextLevel)
                    LoadNextLevel();
            }
        }
        ...
        private void DrawScore(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            //spriteBatch.DrawString(ScreenManager.GameContent.menufont,
            //    "fps : " + fps.ToString("00"), Vector2.Zero, Color.Black);

            spriteBatch.DrawString(ScreenManager.GameContent.menufont,
                "apples collected = " + level.PreviousScore + " + " + level.Score,
                new Vector2(10), Color.Black);
        }
